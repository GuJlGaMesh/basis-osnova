// vanity-1200 / revision 06 / BAZIS 22 / ASCII-safe source.
...
// Library: installed TBM_11_25, Soft-Close Smartline, L=300 mm.
...
(function () {
    var REV = '06', EPS = 0.02, FLOOR = 300;
    var LIBRARY = "C:\\Users\\\u0414\u0435\u043d\u0438\u0441\\Documents\\Bazis\\\u0424\u0440\u0430\u0433\u043c\u0435\u043d\u0442\u044b\\TBM_11_25\\\u0424\u0440\u0430\u0433\u043c\u0435\u043d\u0442\u044b \u0422\u0411\u041c\\\u042f\u0449\u0438\u043a\u0438  Firmax Smartline\\\u041a\u043e\u043c\u043f\u043b\u0435\u043a\u0442 \u043d\u0430\u043f\u0440\u0430\u0432\u043b\u044f\u044e\u0449\u0438\u0445 Soft-Close Firmax Smartline\\\u041a\u043e\u043c\u043f\u043b\u0435\u043a\u0442 \u043d\u0430\u043f\u0440\u0430\u0432\u043b\u044f\u044e\u0449\u0438\u0445 Soft-Close \u0441\u043a\u0440\u044b\u0442\u043e\u0433\u043e \u043c\u043e\u043d\u0442\u0430\u0436\u0430 Firmax Smartline, L=300\u043c\u043c, \u043f\u043e\u043b\u043d\u043e\u0433\u043e \u0432\u044b\u0434\u0432\u0438\u0436\u0435\u043d\u0438\u044f.fr3d";
    ...
    function calculate(input) {
        ...
        c.scope = input.scope;
        requireValue(c.depth >= c.nl + 5, '\u041d\u0435\u0434\u043e\u0441\u0442\u0430\u0442\u043e\u0447\u043d\u043e \u0433\u043b\u0443\u0431\u0438\u043d\u044b \u0434\u043b\u044f Firmax Smartline L=300 mm.');
    ...
    function roundOpen(p, s, c) {
        ...
        function line(x1, z1, x2, z2) {
            if (Math.abs(x1 - x2) + Math.abs(z1 - z2) > 0) segments.push({ a: [x1, z1], b: [x2, z2] });
        }
        ...
        // Exact area of the coordinates sent to CAD; not a CAD measurement.
        // Geometry2D.Area is unavailable in the operator's installed build.
        var sentArea = 0;
        p.Contour.Clear();
        for (var i = 0; i < segments.length; i++) {
            ...
            if (e.mid) {
                var center = localPoint(p, c.centerX, c.centerZ, y);
                var sweep = Math.atan2(b.y - center.y, b.x - center.x) - Math.atan2(a.y - center.y, a.x - center.x);
                while (sweep >= 0) sweep -= 2 * Math.PI;
                while (sweep < -2 * Math.PI) sweep += 2 * Math.PI;
                requireValue(sweep >= -Math.PI - 0.000001 && sweep < 0, 'Invalid round-cut arc sweep');
                var radiusA = Math.sqrt(Math.pow(a.x - center.x, 2) + Math.pow(a.y - center.y, 2));
                var radiusB = Math.sqrt(Math.pow(b.x - center.x, 2) + Math.pow(b.y - center.y, 2));
                requireValue(close(radiusA, c.radius) && close(radiusB, c.radius), 'Invalid round-cut arc radius');
                sentArea += (center.x * (b.y - a.y) - center.y * (b.x - a.x) + c.radius * c.radius * sweep) / 2;
                p.Contour.AddArc(a, b, center, false);
            } else {
                sentArea += (a.x * b.y - b.x * a.y) / 2;
                p.Contour.AddLine(a.x, a.y, b.x, b.y);
            }
        }
        ...
        requireValue(Math.abs(sentArea - (s.w * s.d - removed)) <= 0.1,
    ...
    function mountPair(furniture, c, index) {
        stage = 'Firmax Smartline L=300 mm / \u043f\u0430\u0440\u0430 ' + (index + 1);
        ...
        requireValue(close(lo.x, 16) && close(hi.x, 1184) && close(lo.z, c.runnerFront - 300) && close(hi.z, c.runnerFront),
            '\u041d\u0435 \u0441\u043e\u0432\u043f\u0430\u043b\u0438 \u043c\u043e\u043d\u0442\u0430\u0436\u043d\u044b\u0435 \u0431\u0430\u0437\u044b \u0438\u043b\u0438 \u0440\u0430\u0437\u043c\u0435\u0440 \u0441\u0435\u043a\u0446\u0438\u0438 Firmax Smartline L=300 mm. \u041f\u0440\u043e\u0432\u0435\u0440\u044c\u0442\u0435 \u0431\u0438\u0431\u043b\u0438\u043e\u0442\u0435\u043a\u0443 \u0438 \u043f\u0440\u043e\u0444\u0438\u043b\u044c API.');
        requireValue(close(lo.y, railY) && close(hi.y, railY + 50), '\u041d\u0435\u0432\u0435\u0440\u043d\u0430\u044f \u0432\u044b\u0441\u043e\u0442\u043d\u0430\u044f \u0431\u0430\u0437\u0430 Firmax Smartline L=300 mm.');
    }
    ...
    try {
        ...
        requireValue(furniture && furniture.DatumMode === DatumMode.Box && typeof furniture.MountBox !== 'undefined',
            "\u041d\u0435 \u0443\u0434\u0430\u043b\u043e\u0441\u044c \u043e\u0442\u043a\u0440\u044b\u0442\u044c Firmax Smartline L=300 \u043c\u043c: " + LIBRARY);
        ...
        alert('\u042d\u0421\u041a\u0418\u0417 vanity-1200, \u0440\u0435\u0432\u0438\u0437\u0438\u044f ' + REV + '.\n\u0421\u043e\u0437\u0434\u0430\u043d\u043e 21 \u043f\u0430\u043d\u0435\u043b\u044c (\u0432\u043a\u043b\u044e\u0447\u0430\u044f 2 \u0444\u0430\u0441\u0430\u0434\u0430), 2 \u043f\u0430\u0440\u044b Firmax Smartline L=300 mm, Camar 807 \u0438 68 \u0448\u043a\u0430\u043d\u0442\u043e\u0432 \u043d\u0430 \u043a\u043b\u0435\u044e.\n' +
