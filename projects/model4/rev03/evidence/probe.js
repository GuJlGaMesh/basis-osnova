...
Action.SaveModel(base+'before-selection-fix.b3d');
try {
 buildModel4({dimensions:[600,762,520],savePath:base+'model4-r03-test.b3d'});
 writeReport(base+'r03-built.json',inspectModel(Model,'r03'));
 Model.UnSelectAll();Model.Objects[1].Objects[1].Selected=true;
} catch(e){writeReport(base+'r03-error.json',{error:String(e)});}
