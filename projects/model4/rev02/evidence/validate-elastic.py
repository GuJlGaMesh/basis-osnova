...
for f,d in [('r02-reopened-stretch.json',[800,862,600]),('r02-reopened-shrink.json',[450,712,513]),('r02-return.json',[600,762,523])]:check_model(read(f),d,f)
report={'status':'FAIL' if failures else 'PASS','checks':checks,'cases':27,'reopenedResizeCases':3,'failures':failures,'toleranceMm':0.01}
