...
4. Перед построением собери паспорт по `docs/development/intake.md`. Не угадывай критические размеры, материал, фурнитуру и возможности API.
5. Завершай работу отчётом по `docs/development/quality-gates.md`. Непроведённая проверка не считается пройденной.
