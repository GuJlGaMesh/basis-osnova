...
Читай документы по задаче, не загружай весь каталог без необходимости. Общие инструкции — в корневом `AGENTS.md`.
...
| Генератор по существующей модели | [Короткий маршрут и API-ловушки](development/model-to-script.md), [паспорт](development/intake.md) |
