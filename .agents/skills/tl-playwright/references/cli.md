...
export PWCLI="$CODEX_HOME/skills/tl-playwright/scripts/playwright_cli.sh"
"$PWCLI" --help
```
...
- [Core](#core) — open/close, snapshot, click, type, fill, eval, dialogs
- [Navigation](#navigation) — go-back, go-forward, reload
- [Keyboard](#keyboard) — press, keydown, keyup
- [Mouse](#mouse) — mousemove, mousedown/up, mousewheel
- [Save as](#save-as) — screenshot and pdf
- [Tabs](#tabs) — tab-list, tab-new, tab-select, tab-close
- [DevTools](#devtools) — console, network, run-code, tracing
- [Sessions](#sessions) — named sessions and `PLAYWRIGHT_CLI_SESSION`
